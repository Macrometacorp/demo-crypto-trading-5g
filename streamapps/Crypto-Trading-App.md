...
select "Coinbase Pro" as exchange, "USA" as quote_region,
  ...
  from  UsdCryptoTraderTickerResponseStream[context:getVar('region') == 'gdn-us-nyc']#window.length(10)
...
select "Bitstamp" as exchange, "Europe" as quote_region,
        ...
        time:timestampInMilliseconds()/1000 as timestamp
  from  EurCryptoTraderTickerResponseStream[context:getVar('region') == 'gdn-us-nyc']#window.length(10)
...
select "Bitflyer" as exchange, "Asia-Pacific" as quote_region,
        ...
        time:timestampInMilliseconds()/1000 as timestamp
  from  JpyCryptoTraderTickerResponseStream[context:getVar('region') == 'gdn-us-nyc']#window.length(10)
